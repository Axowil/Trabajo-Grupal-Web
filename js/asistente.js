document.addEventListener("DOMContentLoaded", () => {
    ...
    const STATE_KEY = "rk_chat_state_v1";
    ...
    // =================== MODELO KEYS + MSG (ACTUALIZADO A .PHP) ===================
    const respuestas = [
        {
...

        {
            ...
            msg: [
                "Puedes ver las canchas disponibles en <a href='canchas.php'>Canchas</a>.",
...

        {
            ...
            msg: [
                "Para reservar entra a <a href='reserva.php'>Reservar</a> y completa el formulario.",
                "La reserva se realiza desde <a href='reserva.php'>Reservar</a>."
            ]
        },

        {
            ...
            msg: [
                ...
                "Para ver horarios disponibles, entra a <a href='reserva.php'>Reservar</a>."
            ]
        },

        {
            ...
            msg: [
                ...
                "Consulta los precios al elegir una cancha en <a href='canchas.php'>Canchas</a>."
            ]
        },

        {
            ...
            msg: [
                ...
                "También puedes escribirnos desde <a href='contactanos.php'>Contacto</a>."
            ]
        },

        {
            keys: ["coloso"],
            msg: [
                "El Coloso Club V.C. ⚽ Puedes reservarlo desde <a href='reserva.php'>Reservar</a>."
            ]
        },

        {
            ...
            msg: [
                "FRANCISCO'S CLUB ⚽ Disponible para reservar en <a href='reserva.php'>Reservar</a>."
            ]
        },

        {
            keys: ["san siro", "siro"],
            msg: [
                "Cancha Sintética San Siro ⚽ Puedes reservarla en <a href='reserva.php'>Reservar</a>."
            ]
        },

        {
            ...
            msg: [
                "JARAWA SPORT S.A.C. ⚽ Reserva disponible en <a href='reserva.php'>Reservar</a>."
            ]
        },

        {
            ...
            msg: [
                "Conoce más en <a href='sobreNosotros.php'>Sobre Nosotros</a>."
            ]
        },
